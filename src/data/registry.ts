...
const HANDCRAFTED_TOOLS: MuteToolConfig[] = [
  {
    ...
    description:
      'Combine multiple PDF files into one unified document securely in your browser.',
...

  {
    ...
    description:
      'Reduce image file size by up to 80% without losing visual quality.',
    seoKeywords: [
      'compress image',
      'reduce image size',
      'optimize jpg',
...

  {
    ...
    category: 'Image Tools (AI & Utility)',
    description:
      'Generate stunning, hyper-realistic images using advanced AI models.',
    seoKeywords: [
      'ai image generator',
      'text to image',
      'flux ai',
    ...
    options: [
      {
        ...
        type: 'textarea',
        defaultValue: 'A futuristic cyberpunk city',
        required: true,
      },
      {
        id: 'aspectRatio',
...
export const TOOL_REGISTRY: MuteToolConfig[] =
  generatePlatformCatalog();

export const getToolConfig = (
  toolId: string
): MuteToolConfig | undefined => {
